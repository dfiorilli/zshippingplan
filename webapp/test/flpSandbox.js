		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Shipping Plan Copilot",
									"targetURL": "#itdeloittecopilotzshippingplan-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"itdeloittecopilotzshippingplan-display": {
								"semanticObject": "itdeloittecopilotzshippingplan",
								"action": "display",
								"description": "Shipping Plan Copilot app Fiori",
								"title": "Shipping Plan Copilot",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=it.deloitte.copilot.zshippingplan",
									"url": sap.ui.require.toUrl("it/deloitte/copilot/zshippingplan")
								}
							}
						}
					}
